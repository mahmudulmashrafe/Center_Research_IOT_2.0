...
if (isset($_GET['toggle'])) {
    ...
    $conn->query("INSERT INTO distance_table_status (status) VALUES ($newStatus)");
...
// Insert distance data if status is 1
if (isset($_GET['distance'])) {
    ...
    if ($currentStatus == 1) {
        ...
        $sql = "INSERT INTO distance_data_2 (distance) VALUES ($distance)";
